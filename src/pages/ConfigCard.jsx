      ...
      <div className="config-container" style={{ "--primary-color": formData.primaryColor }}>
        ...
        <form className="config-form" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="form-section">
            <h2>
              <svg width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                <path d="M6.354 5.5H4a3 3 0 0 0 0 6h3a3 3 0 0 0 2.83-4H9c-.086 0-.17.01-.25.031A2 2 0 0 1 7 5.5zM4 6.5a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm3-1A2.5 2.5 0 0 0 4.5 8a.5.5 0 0 0 1 0A1.5 1.5 0 0 1 7 6.5a.5.5 0 0 0 0-1zm4.5 0a3 3 0 0 1 0 6H9a3 3 0 0 1-2.83-4H7c.086 0 .17.01.25.031A2 2 0 0 0 9 9.5h2.5a1.5 1.5 0 1 0 0-3H9a.5.5 0 0 1 0-1h2.5z"/>
              </svg>
              Links
            </h2>
